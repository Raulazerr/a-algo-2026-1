...
class Grafo:
    ...
    def executar_kruskal_maximo(self):
        ...
        e = 0  # Contagem de arestas na Árvore final
        custo_total = 0

        # Passo 1: Ordenar todas as arestas do MAIOR para o MENOR peso (reverse=True)
        ...
        # Adicionado verificação `i < len(self.grafo)` por segurança caso o grafo seja desconexo
...
if __name__ == '__main__':
    ...
    print("Rotas escolhidas para a rede (Caminho mais caro sem ciclos):")
    for u, v, peso in caminho_final:
        print(f"Rota da cidade {u} para a cidade {v} | Custo: {peso}")
    print(f"\nCusto Total Máximo da Obra: {custo_final}")
